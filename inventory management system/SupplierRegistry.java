 ...
 *
 * Created on Jul 11, 2011, 1:30:00 PM
 */
/**
 *
 * @author ABC
...
public class SupplierRegistry extends javax.swing.JFrame {

    /** Creates new form SupplierRegistry */
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(inventoryproject.InventoryApp.class).getContext().getResourceMap(SupplierRegistry.class);
        mainPanel.setBackground(resourceMap.getColor("mainPanel.background")); // NOI18N
        mainPanel.setName("mainPanel"); // NOI18N
        mainPanel.setPreferredSize(new java.awt.Dimension(580, 516));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if(validateForm()) {
                ...
                ResultSet rs = st.executeQuery("select * from supplierregistry");
                int n =3001;
                if(rs.next()) {
                    while(rs.next()) {
                        n = rs.getInt(1);
                ...
                String sql = "insert into supplierregistry values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                pst.setString(15,textField1.getText().trim());
                pst.setString(16,textField2.getText().trim());
        ...
        public boolean validateForm()
    {
      ...
      {
          JOptionPane.showMessageDialog(null, "Father's nane not alphabetic");
          return false;
      }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new SupplierRegistry().setVisible(true);
            }
        });
    }
