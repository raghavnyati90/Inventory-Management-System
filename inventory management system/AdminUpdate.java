 ...
 * AdminUpdate.java
 *
 * Created on Jul 11, 2011, 1:52:11 PM
 */
/**
 *
 * @author ABC
...
public class AdminUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(inventoryproject.InventoryApp.class).getContext().getResourceMap(AdminUpdate.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "select * from adminregistry where id =?";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/main","root","dellstudio15");
            String sql = "delete from adminregistry where id=?";
            PreparedStatement pst = cn.prepareStatement(sql);
            int n = Integer.parseInt(jTextField1.getText().trim());
            pst.setInt( 1,n);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/main","root","dellstudio15");
            String sql = "update adminregistry set name=?, fname=?, dob=?, sex=?, mstatus=?, address=?, city=?, state=?, country=?, pin=?, phno=?, mobileno=?, email=?, password=?, confirmpassword=? where id=?";
            PreparedStatement pst = cn.prepareStatement(sql);
            int n = Integer.parseInt(jTextField1.getText().trim());
