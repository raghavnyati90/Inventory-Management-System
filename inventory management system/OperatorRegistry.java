 ...
 *
 * Created on Jul 11, 2011, 1:28:21 PM
 */
/**
 *
 * @author ABC
...
public class OperatorRegistry extends javax.swing.JFrame {

    /** Creates new form OperatorRegistry */
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(inventoryproject.InventoryApp.class).getContext().getResourceMap(OperatorRegistry.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if(validateForm()) {
                ...
                ResultSet rs = st.executeQuery("select * from operatorregistry");
                int n =2001;
                if(rs.next()) {
                    while(rs.next()) {
                        n = rs.getInt(1);
                ...
                String sql = "insert into operatorregistry values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new OperatorRegistry().setVisible(true);
            }
        });
    }
